                ...
                <div class="card" style="width: 40rem;">
                    <div class="card-body">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="date" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" id="tarikh" name="tarikh" min="" required>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select form-control" id="inputGroupSelect01" name="masa" required>
                                <option selected disabled value="">Choose...</option>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select form-control" id="inputGroupSelect01" name="kaunselor" required>
                                <option selected disabled value="">Choose...</option>
